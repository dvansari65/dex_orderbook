...
use orderbook::state::{OrderStatus, Slab};
use std::str::FromStr;
...
fn test_insert_order() {
    ...
    // Insert first order
    slab.insert_order(1, 100, owner, 50,order_status).unwrap();
    ...
    slab.insert_order(2, 200, owner, 30,order_status).unwrap();
    ...
    slab.insert_order(3, 150, owner, 60,order_status).unwrap();
